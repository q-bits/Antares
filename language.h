...
o_older                     = "Existing file is older";
o_older_plural              = "Existing files are older";
o_newer                     = "Existing file is newer";
o_newer_plural              = "Existing files are newer";
o_wrong_size                = "Existing file has same date but different size";
o_wrong_size_plural         = "Existing files have same date but different size";
o_category_a                = "REC files or large files";
...
s_prevent_turbo             = "Älä käytä Turbo-moodia tallennuksessa";
