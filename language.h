...
c_checking                  = "Levytilaa PVR:ssä tarkistetaan...";
c_folder_error              = "Kansiota {0} ei voida luoda. Siirto hylätään.";
...
c_no_access_pvr             = "Seuraavaa tiedostoa ei voida tallentaa PVR:lle:";
c_no_access_pvr_plural      = "Seuraavia tiedostoja ei voida tallentaa PVR:lle:";
c_no_access_pc              = "Seuraavaa tiedostoa ei voida tallentaa PC:lle:";
c_no_access_pc_plural       = "Seuraavia tiedostoja ei voida tallentaa PC:lle:";
...
b_no                        = "Ei";
b_close                     = "Sulje";
b_cancel_transfer           = "Hylkää siirto";
c_title1_copy               = "Kopioidaan tiedosto(ja)";
c_title1_move               = "Siirretään tiedosto(ja)";
c_title1b_copy              = "Kopioidaan tiedosto {0} tiedostoista {1}";
c_title1b_move              = "Siirretään tiedosto {0} tiedostoista {1}";
c_title2_to_pc              = "[PVR --> PC]";
c_title2_to_pvr             = "[PC --> PVR]";
c_finding                   = "Etsitään tiedostoja...";
c_completion                = "Viimeistellään:";
c_sleep                     = "Lepotila";
...
o_oversized_plural          = "Nämä tiedostot ovat suurempia!";
o_oversized                 = "Tämä tiedosto on suurempi!";
o_skip                      = "Ohita";
o_overwrite                 = "Korvaa";
...
m_rename_error              = "Virhe uudelleen nimeämisessä";
...
cm_explorer                 = "Näytä tiedostonhallinnassa";
